    ...
    <div style={{ fontFamily: "'Plus Jakarta Sans', 'Manrope', sans-serif", minHeight: '100vh', background: '#060C18', color: '#fff' }}>
      ...
      <style>{`
        ...
        *{box-sizing:border-box;}
        ...
        .govai-input:focus{border-color:rgba(34,197,94,.5);}
        ...
        .sidebar-item.active{background:rgba(34,197,94,.12);color:#22C55E;}
        ...
        .filter-pill.active{background:#22C55E;color:#fff;border-color:#22C55E;box-shadow:0 2px 10px rgba(34,197,94,.28);}
        ...
        .btn-primary{
          background:#22C55E;border:none;border-radius:10px;padding:10px 20px;
