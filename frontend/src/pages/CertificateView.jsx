...
export default function CertificateView() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4 print:py-0 print:px-0 print:bg-white relative">
      ...
      {/* Action Bar */}
      <div className="w-full max-w-4xl flex flex-col gap-4 mb-6 print:hidden">
         ...
         <div className="bg-blue-50 border border-blue-200 p-3 rounded-xl flex items-start gap-3">
            <div className="bg-blue-500 text-white p-1 rounded-full"><ShieldCheck size={14} /></div>
            <p className="text-xs text-blue-700 font-medium">
               <strong>Pro Tip:</strong> To ensure the barcode, signature, and colors appear in your PDF, please enable <strong>"Background Graphics"</strong> in your browser's print settings.
            </p>
         </div>
      </div>
